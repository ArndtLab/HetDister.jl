...
"""
    adapt_histogram(segments::AbstractVector{<:Integer}; lo::Int=1, hi::Int=1_000_000, nbins::Int=800)
...
"""
function adapt_histogram(segments::AbstractVector{<:Integer}; lo::Int=1, hi::Int=1_000_000, nbins::Int=800)
